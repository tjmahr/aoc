...
aoc provides [usethis](https://usethis.r-lib.org/)-style functions for Advent of
Code puzzles. This package only downloads content from the Advent of Code
site. 
...
writeLines(brio::read_lines("R/data-solutions.R"))
```
...
```{r, echo = FALSE, comment = ""}
writeLines(brio::read_lines("R/day01.R"))
```
...
```{r, echo = FALSE, comment = ""}
writeLines(brio::read_lines("tests/testthat/test-day01.R"))
```
...
```{r, echo = FALSE, comment = ""}
writeLines(brio::read_lines("inst/run-day01.R"))
```
...
```{r, echo = FALSE, comment = ""}
writeLines(c(head(brio::read_lines("R/day03.R")), "[... truncated ...]"))
```
...
```{r, echo = FALSE, comment = ""}
writeLines(c(head(brio::read_lines("inst/run-day04.R")), "[... truncated ...]"))
```
